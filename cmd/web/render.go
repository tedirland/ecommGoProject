...
func (app *applicaiton) addDefaultData(td *templateData, r *http.Request) *templateData {
	return td
}

func (app *applicaiton) renderTemplate(w http.ResponseWriter, r http.Request, page string, td *templateData, partials ...string) error {
...
func (app *applicaiton) parseTemplate(partials []string, page string, templateToRender string) (*template.Template, error) {
